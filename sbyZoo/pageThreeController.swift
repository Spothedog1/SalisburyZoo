...
class pageThreeController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        label.text = "Click on the locked animal to unlock it"
        ...
        qrLabel.text = "Congratulations! You've added an animal!"
        ...
        imageView.image = UIImage(named: "bison")
    ...
    func cancel(sender: UIButton!) {
        self.performSegue(withIdentifier: "cancelOnboardThree", sender: self)
    }
