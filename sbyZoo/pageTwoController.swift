...
class pageTwoController: UIViewController {
    override func viewDidLoad() {
        ...
        label.text = "Press the plus button in the top right"
        ...
        qrLabel.text = "Scan the code to add the animal to your collection"
        ...
        imageView.image = UIImage(named: "undiscoveredOnboard")
    ...
    func cancel(sender: UIButton!) {
        self.performSegue(withIdentifier: "cancelOnboardTwo", sender: self)
    }
